...
function Region({ selectChange, themeChanger }) {
  return (
    <select
      ...
      id=""
      className="dark:bg-gray-700 bg-white border border-gray-300 dark:border-none dark:text-white rounded-sm"
    ...
    >
      ...
      <option value="filter by region" disabled className="hg">
        Filter by Region
      </option>
    </select>
  );
