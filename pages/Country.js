...
function Country({modal, content, onClose, themeChanger}) {
  return (
   ...
   >
    <div onClick={e => e.stopPropagation()} className='p-5 w-11/12  lg:w-2/4 mx-auto text-black dark:text-white dark:bg-gray-800 bg-gray-300 rounded-lg md:w-9/12 '>
    <div className=''>
            <div  className=''>
                <div>
                ...
                <h1 className=' text-sm md:text-base'>Native Name: <span className='font-light'>{content.nativeName}</span></h1>
                <h1 className=' text-sm md:text-base'>Sub Region: <span className='font-light'>{content.subRegion}</span></h1>
                <h1 className=' text-sm md:text-base'>Capital: <span className='font-light'>{content.capital}</span></h1>
                <h1 className=' text-sm md:text-base'>Population: <span className='font-light'>{content.population}</span></h1>
                ...
                <h1 className='pt-2 text-center flex flex-col items-center text-sm md:text-base'>Border Countries: <span className='pt-5 w-full flex items-center justify-between w-3/5'>{content.borderCountries}</span></h1>
