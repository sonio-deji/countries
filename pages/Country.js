   ...
   >
    ...
    <div className=''>
            <div  className=''>
                ...
                <h1 className='pt-2 text-center flex flex-col items-center text-sm md:text-base'>Border Countries: <span className='pt-5 flex items-center justify-between w-3/5'>{content.borderCountries}</span></h1>
