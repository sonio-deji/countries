   ...
   >
    ...
    <div className=''>
            <div  className=''>
                ...
                <h1>Native Name: <span className='font-light text-gray-300'>{content.nativeName}</span></h1>
                <h1>Sub Region: <span className='font-light text-gray-300'>{content.subRegion}</span></h1>
                <h1>Capital: <span className='font-light text-gray-300'>{content.capital}</span></h1>
                <h1>Population: <span className='font-light text-gray-300'>{content.population}</span></h1>
                ...
                <h1 className='flex items-baseline'>Top level Domain: <span className='font-light pl-2 text-gray-300'>{content.topLevelDomain}</span></h1>
                <h1 className='flex items-center'>Border Countries: <span className='flex justify-between w-3/5 text-gray-300'>{content.borderCountries}</span></h1>
