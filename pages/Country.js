   ...
   >
    ...
    <div className=''>
            <div  className=''>
                ...
                <h1 className='pt-2 text-center flex flex-col items-center text-sm md:text-base'>Border Countries: <span className='pt-5 w-full flex items-center justify-evenly'>{content.borderCountries}</span></h1>
