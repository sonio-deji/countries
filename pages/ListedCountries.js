  ...
  return (
    <>
      <div className={`${props.themeChanger && "dark"}`}>
        <div
          className={`text-black bg-gray-200 dark:bg-gray-700 dark:text-white cursor-pointer border border-gray-400 h-80 sm:h-fit md:h-fit lg:h-fit dark:border-none rounded-lg ${
            props.themeChanger && "dark"
          }`}
          onClick={setClicked}
        >
          <div>
      ...
      <Country
        modal={modal}
        themeChanger={props.themeChanger}
        content={content}
